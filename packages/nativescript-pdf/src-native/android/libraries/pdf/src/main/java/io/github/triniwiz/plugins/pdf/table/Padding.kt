...
class Padding(
  ...
  companion object {
    ...
    @JvmStatic
    fun default(uniform: Float): Padding {
      val ret = Padding(uniform)
      ret.topChanged = false
      ret.leftChanged = false
      ret.bottomChanged = false
      ret.rightChanged = false
    ...
    @JvmStatic
    fun default(left: Float, right: Float, top: Float, bottom: Float): Padding {
      val ret = Padding(top, left, bottom, right)
      ret.topChanged = false
      ret.leftChanged = false
      ret.bottomChanged = false
      ret.rightChanged = false
