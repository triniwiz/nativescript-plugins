...
SWIFT_ENUM_FWD_DECL(NSInteger, NSCPdfSection)
...
SWIFT_ENUM_FWD_DECL(int32_t, NSCPdfOrientation)
@class NSCPdfTextOptions;
@class NSCPdfImage;
@class UIImage;
SWIFT_ENUM_FWD_DECL(NSInteger, NSCPdfStyle)
@class NSMutableData;
@class NSCPdfTable;
...
SWIFT_ENUM_FWD_DECL(int32_t, NSCPdfUnit)
...
SWIFT_ENUM_FWD_DECL(uint32_t, NSCPdfStandardPaperSize)
...
SWIFT_ENUM_FWD_DECL(NSInteger, NSCPdfVerticalAlign)
...
SWIFT_ENUM_FWD_DECL(NSInteger, NSCPdfTableTheme)
