...
export declare class Stripe {
	...
	createBankAccountToken(account: BankAccountParams, cb: (error: Error, token: Token) => void): void;
...
export declare class BankAccountParams implements IBankAccount {
	readonly native: any;
	constructor();
	constructor(params: STPBankAccountParams);
	constructor(accountNumber: string, accountHolderName: string, country: string, currency: string, accountHolderType?: BankAccountHolderType);
