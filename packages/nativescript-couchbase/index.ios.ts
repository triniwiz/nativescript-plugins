...
import { getExtension, QueryArrayOperator, QueryLogicalOperator, QueryMeta, ReplicatorConfiguration } from './common';
...
export class MutableDocument extends Document {
	...
	constructor(id?: string | ObjectType | CBLMutableDocument) {
		super();
