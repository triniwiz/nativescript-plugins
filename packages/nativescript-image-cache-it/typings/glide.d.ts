	...
	export module bumptech {
		export module glide {
			export class BuildConfig {
				public static class: java.lang.Class<com.bumptech.glide.BuildConfig>;
	...
	export module bumptech {
		export module glide {
			export class Glide {
				...
				public static with(param0: globalAndroid.support.v4.app.FragmentActivity): com.bumptech.glide.RequestManager;
				...
				public static with(param0: globalAndroid.support.v4.app.Fragment): com.bumptech.glide.RequestManager;
	...
	export module bumptech {
		export module glide {
			...
			export module ListPreloader {
				...
				export class PreloadTarget extends com.bumptech.glide.request.target.BaseTarget<any> {
	...
	export module bumptech {
		export module glide {
			...
			export module RequestManager {
				export class ClearTarget extends com.bumptech.glide.request.target.ViewTarget<globalAndroid.view.View,any> {
				...
				export module engine {
					...
					export module EngineJob {
						...
						export class EngineResourceFactory {
							...
							public build(param0: com.bumptech.glide.load.engine.Resource<any>, param1: boolean): com.bumptech.glide.load.engine.EngineResource<any>;
						}
			...
			export module load {
				export module engine {
					export class LoadPath<Data, ResourceType, Transcode>  extends java.lang.Object {
						...
						public constructor(param0: java.lang.Class<Data>, param1: java.lang.Class<ResourceType>, param2: java.lang.Class<Transcode>, param3: java.util.List<com.bumptech.glide.load.engine.DecodePath<Data,ResourceType,Transcode>>, param4: globalAndroid.support.v4.util.Pools.Pool<java.util.List<java.lang.Throwable>>);
...
declare module com {
	export module bumptech {
		export module glide {
			export module load {
				export module engine {
					export class SourceGenerator extends java.lang.Object {
				...
				export module engine {
					export module executor {
						export class GlideExecutor {
							...
							public submit(param0: java.util.concurrent.Callable): java.util.concurrent.Future<any>;
			...
			export module load {
				export module model {
					export class ModelLoaderRegistry {
						...
						public getModelLoaders(param0: any): java.util.List<any>;
						public constructor(param0: globalAndroid.support.v4.util.Pools.Pool<java.util.List<java.lang.Throwable>>);
					...
					export module ModelLoaderRegistry {
						export class ModelLoaderCache {
							...
							public put(param0: java.lang.Class<any>, param1: java.util.List): void;
							public clear(): void;
				...
				export module model {
					...
					export module MultiModelLoaderFactory {
						...
						export class Factory {
							...
							public build(param0: java.util.List<any>, param1: globalAndroid.support.v4.util.Pools.Pool): com.bumptech.glide.load.model.MultiModelLoader<any,any>;
						}
					}
				}
			}
				...
				export module resource {
					export module gif {
						export class GifDrawable implements com.bumptech.glide.load.resource.gif.GifFrameLoader.FrameCallback {
							...
							public registerAnimationCallback(param0: globalAndroid.support.graphics.drawable.Animatable2Compat.AnimationCallback): void;
							...
							public unregisterAnimationCallback(param0: globalAndroid.support.graphics.drawable.Animatable2Compat.AnimationCallback): boolean;
				...
				export module resource {
					export module gif {
						...
						export module GifFrameLoader {
							export class DelayTarget extends com.bumptech.glide.request.target.SimpleTarget<globalAndroid.graphics.Bitmap> {
		...
		export module glide {
			export module manager {
				export class RequestManagerRetriever {
					...
					public get(param0: globalAndroid.support.v4.app.Fragment): com.bumptech.glide.RequestManager;
					public get(param0: globalAndroid.app.Activity): com.bumptech.glide.RequestManager;
					public handleMessage(param0: globalAndroid.os.Message): boolean;
					public get(param0: globalAndroid.support.v4.app.FragmentActivity): com.bumptech.glide.RequestManager;
				}
		...
		export module glide {
			export module manager {
				export class RequestTracker {
					...
					public isPaused(): boolean;
					public clearRemoveAndRecycle(param0: com.bumptech.glide.request.Request): boolean;
					public resumeRequests(): void;
				}
			}
		}
		...
		export module glide {
			export module request {
				export class SingleRequest<R>  extends java.lang.Object {
					...
					public isRunning(): boolean;
					public isEquivalentTo(param0: com.bumptech.glide.request.Request): boolean;
					public static obtain(param0: globalAndroid.content.Context, param1: com.bumptech.glide.GlideContext, param2: any, param3: java.lang.Class<any>, param4: com.bumptech.glide.request.BaseRequestOptions<any>, param5: number, param6: number, param7: com.bumptech.glide.Priority, param8: com.bumptech.glide.request.target.Target<any>, param9: com.bumptech.glide.request.RequestListener<any>, param10: java.util.List<any>, param11: com.bumptech.glide.request.RequestCoordinator, param12: com.bumptech.glide.load.engine.Engine, param13: com.bumptech.glide.request.transition.TransitionFactory<any>, param14: java.util.concurrent.Executor): com.bumptech.glide.request.SingleRequest<any>;
					public getVerifier(): com.bumptech.glide.util.pool.StateVerifier;
				}
		...
		export module glide {
			export module request {
				export module target {
					export class AppWidgetTarget extends com.bumptech.glide.request.target.SimpleTarget<globalAndroid.graphics.Bitmap> {
...
declare module com {
	export module bumptech {
		export module glide {
			export module request {
				export module target {
					export class NotificationTarget extends com.bumptech.glide.request.target.SimpleTarget<globalAndroid.graphics.Bitmap> {
...
declare module com {
	export module bumptech {
		export module glide {
			export module request {
				export module target {
					export class PreloadTarget<Z>  extends com.bumptech.glide.request.target.SimpleTarget<any> {
...
declare module com {
	export module bumptech {
		export module glide {
			export module util {
				export class CachedHashCodeArrayMap<K, V>  extends globalAndroid.support.v4.util.ArrayMap<any,any> {
					public static class: java.lang.Class<com.bumptech.glide.util.CachedHashCodeArrayMap<any,any>>;
					public putAll(param0: globalAndroid.support.v4.util.SimpleArrayMap<any,any>): void;
		...
		export module glide {
			export module util {
				...
				export module ViewPreloadSizeProvider {
					export class SizeViewTarget extends com.bumptech.glide.request.target.ViewTarget<globalAndroid.view.View,any> {
			...
			export module util {
				export module pool {
					export class FactoryPools {
						...
						public static threadSafe(param0: number, param1: com.bumptech.glide.util.pool.FactoryPools.Factory<any>): globalAndroid.support.v4.util.Pools.Pool;
						public static threadSafeList(param0: number): globalAndroid.support.v4.util.Pools.Pool;
						public static threadSafeList(): globalAndroid.support.v4.util.Pools.Pool;
						public static simple(param0: number, param1: com.bumptech.glide.util.pool.FactoryPools.Factory<any>): globalAndroid.support.v4.util.Pools.Pool;
					}
					export module FactoryPools {
						...
						export class FactoryPool<T>  extends globalAndroid.support.v4.util.Pools.Pool<any> {
