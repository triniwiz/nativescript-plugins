...
import { SupabaseStorageClient } from '@triniwiz/nativescript-supabase-storage';
import { PostgrestClient } from '@triniwiz/nativescript-supabase-postgrest';
import { RealtimeClient, RealtimeSubscription } from '@triniwiz/nativescript-supabase-realtime';
...
export default class SupabaseClient {
	...
	private _initSupabaseAuthClient({ autoRefreshToken, persistSession, detectSessionInUrl, localStorage }: SupabaseClientOptions) {
