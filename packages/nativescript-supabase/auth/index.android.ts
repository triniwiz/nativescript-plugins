...
export class UserIdentity {
	...
	get createdAt(): Date {
		// todo
		return this.native.getCreatedAt() as never;
	}
	...
	get lastSignInAt(): Date {
		// todo
		return this.native.getLastSignInAt() as never;
	}
	...
	get updatedAt(): Date {
		// todo
		return this.native.getUpdatedAt() as never;
	}
...
export class User {
	...
	get confirmationSentAt(): Date {
		return this.native.getConfirmationSentAt();
	}

	get confirmedAt(): Date {
		return this.native.getConfirmedAt();
	}
	...
	get emailChangeSentAt(): Date {
		return this.native.getEmailChangeSentAt();
	}

	get emailConfirmedAt(): Date {
		return this.native.getEmailConfirmedAt();
	}
	...
	get invitedAt(): Date {
		return this.native.getInvitedAt();
	}
	...
	get lastSignInAt(): Date {
		return this.native.getLastSignInAt();
	}
	...
	get phoneConfirmedAt(): Date {
		return this.native.getPhoneConfirmedAt();
	}

	get recoverySentAt(): Date {
		return this.native.getRecoverySentAt();
	}
...
export class Session {
	native: io.github.jan.supabase.auth.user.UserSession;
	...
	get expiresAt(): number {
		return this.native.getExpiresAt().epochSeconds();
	}
	...
	get isExpired(): boolean {
		// todo
		return false; //this.native.isExpired;
	}
