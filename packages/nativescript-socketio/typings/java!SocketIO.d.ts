	...
	export module socket {
		export module client {
			export class Ack {
				 ...
				 */
				public constructor(implementation: { call(param0: native.Array<any>): void });
				public constructor();
		...
		export module client {
			...
			export module Manager {
				...
				export class OpenCallback {
					 ...
					 */
					public constructor(implementation: { call(param0: java.lang.Exception): void });
					public constructor();
		...
		export module parser {
			...
			export module Parser {
				export class Decoder {
					 ...
					 */
					public constructor(implementation: { add(param0: string): void; add(param0: native.Array<number>): void; destroy(): void; onDecoded(param0: io.socket.parser.Parser.Decoder.Callback): void });
					public constructor();
					public add(param0: string): void;
					public destroy(): void;
					public add(param0: native.Array<number>): void;
				...
				export module Decoder {
					export class Callback {
						 ...
						 */
						public constructor(implementation: { call(param0: io.socket.parser.Packet<any>): void });
						public constructor();
				...
				export class Encoder {
					 ...
					 */
					public constructor(implementation: { encode(param0: io.socket.parser.Packet<any>, param1: io.socket.parser.Parser.Encoder.Callback): void });
					public constructor();
					public encode(param0: io.socket.parser.Packet<any>, param1: io.socket.parser.Parser.Encoder.Callback): void;
				}
