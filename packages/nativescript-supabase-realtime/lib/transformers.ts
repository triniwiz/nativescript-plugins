 ...
 */
export const convertChangeData = (columns: Column[], records: Records, options: { skipTypes?: string[] } = {}) => {
 ...
 * //=> "33"
 */
export const convertColumn = (columnName: string, columns: Column[], records: Records, skipTypes: string[]): any => {
