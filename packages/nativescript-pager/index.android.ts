...
export class Pager extends PagerBase {
	...
	public createNativeView() {
		...
		const params = new android.widget.RelativeLayout.LayoutParams(android.widget.RelativeLayout.LayoutParams.WRAP_CONTENT, android.widget.RelativeLayout.LayoutParams.WRAP_CONTENT);
	...
	public initNativeView() {
		...
		this._setTransformers(this.transformer ? this.transformer : '');
...
function initStaticPagerStateAdapter() {
	...
	class StaticPagerStateAdapterImpl extends androidx.recyclerview.widget.RecyclerView.Adapter<any> {
		...
		public getItemCount(): number {
			const owner = this.owner ? this.owner.get() : null;
			return owner && owner._childrenViews ? owner._childrenViews.size : 0;
		}
...
function initZoomOutPageTransformer() {
	...
	class ZoomOutPageTransformerImpl extends java.lang.Object implements Partial<androidx.viewpager2.widget.ViewPager2.PageTransformer> {
		owner: WeakRef<Pager>;
...
function initZoomInPageTransformer() {
	...
	@NativeClass
	@Interfaces([androidx.viewpager2.widget.ViewPager2.PageTransformer])
	class ZoomInPageTransformerImpl extends java.lang.Object implements Partial<androidx.viewpager2.widget.ViewPager2.PageTransformer> {
		owner: WeakRef<Pager>;
