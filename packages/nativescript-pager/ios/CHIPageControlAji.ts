...
import {AnimationFrameImpl} from "@triniwiz/nativescript-pager/ios/core/AnimationFrame";

@NativeClass
class CHIPageControlAji extends UIControl implements CHIPageControllable {
...
Base Controller
  ...
  update(progress: number) {
    ...
    if (min && max && isNotEmpty && hasProgress) {
