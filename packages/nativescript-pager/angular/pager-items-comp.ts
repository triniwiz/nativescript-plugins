import { AfterContentInit, Component, ContentChild, Directive, DoCheck, ElementRef, EmbeddedViewRef, EventEmitter, Host, Inject, InjectionToken, Input, IterableDiffer, IterableDiffers, NgZone, OnDestroy, OnInit, Output, TemplateRef, ViewChild, ViewContainerRef } from '@angular/core';
...
import { extractSingleViewRecursive, isInvisibleNode, registerElement, isListLikeIterable } from '@nativescript/angular';
...
@Directive({ selector: '[pagerTemplateKey]', standalone: false })
