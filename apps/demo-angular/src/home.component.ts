...
export class HomeComponent {
	demos = [
		...
		{
			name: 'nativescript-awesome-loaders',
		},
		{
		...
		{
			name: 'nativescript-card-io',
		},
		{
			name: 'nativescript-couchbase',
		},
		{
			name: 'nativescript-ddp-login',
		},
		{
			name: 'nativescript-downloader',
		},
		{
			name: 'nativescript-fancy-camera',
		},
		{
		...
		{
			name: 'nativescript-mongo-stitch-sdk',
		},
		{
			name: 'nativescript-mongo-stitch-services-mongodb-remote',
		},
		{
