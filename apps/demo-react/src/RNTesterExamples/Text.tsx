	...
	render() {
		...
		return (
			<View style={{ direction: isRTL ? 'rtl' : 'ltr' }}>
				...
				<Text style={{ textAlign: 'left' }}>left left left left left left left left left left left left left left left</Text>
				<Text style={{ textAlign: 'center' }}>center center center center center center center center center center center</Text>
				<Text style={{ textAlign: 'right' }}>right right right right right right right right right right right right right</Text>
				<Text style={{ textAlign: 'justify' }}>justify: this text component{"'"}s contents are laid out with "textAlign: justify" and as you can see all of the lines except the last one span the available width of the parent container.</Text>
				<Button onPress={toggleRTL} title={`Switch to ${isRTL ? 'LTR' : 'RTL'}`} />
			</View>
		);
	}
}
...
class Entity extends React.Component<{}> {
	render() {
		return <Text style={{ fontWeight: '500', color: '#527fe4' }}>{this.props.children}</Text>;
	}
}
...
class AttributeToggler extends React.Component<{}, {}> {
	...
	render() {
		...
		return (
			<View>
				<Text style={curStyle}>Tap the controls below to change attributes.</Text>
				<Text>
					<Text>
						See how it will even work on <Text style={curStyle}>this nested text</Text>
					</Text>
				</Text>
...
class TextRenderInfoExample extends React.Component<{}, {}> {
	...
	render() {
		const topOfBox = this.state.textMetrics.y + this.state.textMetrics.height - (this.state.textMetrics.descender + this.state.textMetrics.capHeight);
		return (
			<View>
				<View>
					<View
					...
					>
						{new Array(this.state.numberOfTextBlocks).fill('A tiny block of text.').join(' ')}
					</Text>
				</View>
				<Text
					onPress={() =>
				...
				<Text onPress={() => this.setState({ fontSize: this.state.fontSize + 1 })}>Increase size</Text>
				<Text onPress={() => this.setState({ fontSize: this.state.fontSize - 1 })}>Decrease size</Text>
			</View>
		);
	}
}
...
export const examples: Example[] = [
	{
		title: 'Wrap',
		render: function () {
			return <Text>The text should wrap if it goes on multiple lines. See, this is going to the next line.</Text>;
		},
	},
		...
		render: function () {
			return (
				<Text style={{ backgroundColor: '#00000020', padding: 10 }}>
					Text in a gray box!
					<Text style={{ backgroundColor: 'red' }}>Another text in a (inline) red box (which is inside the gray box).</Text>
				</Text>
			);
		},
	},
	...
	},
	{
		title: 'Padding',
		render: function () {
			return <Text style={{ padding: 10 }}>This text is indented by 10px padding on all sides.</Text>;
		},
	},
	{
		title: 'Font Family',
		render: function () {
			return (
				<View>
					<Text style={{ fontFamily: Platform.isTV ? 'Times' : 'Cochin' }}>Cochin</Text>
					<Text
						style={{
					...
					<Text style={{ fontFamily: Platform.isTV ? 'Courier' : 'Verdana' }}>Verdana</Text>
					<Text
						style={{
		...
		render: function () {
			return (
				<View>
					...
					<Text style={{ textDecorationLine: 'underline line-through' }}>Both underline and line-through</Text>
				</View>
			);
		},
	},
		...
		render: function () {
			return (
				<View>
					...
					>
						[letterSpacing = 3]
						<Text style={{ letterSpacing: 0, backgroundColor: '#bbbbbb' }}>[Nested letterSpacing = 0]</Text>
						<Text style={{ letterSpacing: 6, backgroundColor: '#eeeeee' }}>[Nested letterSpacing = 6]</Text>
					</Text>
				</View>
			);
		},
	...
	},
	{
		...
		render: function () {
			return (
				<Text>
					<Text style={{ lineHeight: 35 }}>A lot of space between the lines of this long passage that should wrap once.</Text>
				</Text>
			);
		},
	},
	...
	// },
	{
		...
		render: function () {
			return (
				<View>
					<Text numberOfLines={1}>Maximum of one line, no matter how much I write here. If I keep writing, it{"'"}ll just truncate after one line.</Text>
					<Text numberOfLines={2} style={{ marginTop: 20 }}>
						Maximum of two lines, no matter how much I write here. If I keep writing, it{"'"}ll just truncate after two lines.
					</Text>
					<Text style={{ marginTop: 20 }}>No maximum lines specified, no matter how much I write here. If I keep writing, it{"'"}ll just keep going and going.</Text>
				</View>
			);
		},
	},
	...
	},
	{
		...
		render: function () {
			return (
				<View>
					<Text>
						By default, text will respect Text Size accessibility setting on iOS. It means that all font sizes will be increased or decreased depending on the value of Text Size setting in <Text style={{ fontWeight: 'bold' }}>Settings.app - Display & Brightness - Text Size</Text>
					</Text>
					...
					<Text allowFontScaling={false} style={{ marginTop: 20, fontSize: 15 }}>
						This text will not scale. <Text style={{ fontSize: 15 }}>This text also won't scale because it inherits "allowFontScaling" from its parent.</Text>
					</Text>
				</View>
			);
		},
